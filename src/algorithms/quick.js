const quickSort = (arr, ele) => {
    ...
    const partition = async (array, low, high) => {
        ...
        [ ele.current.childNodes[i + 1].style.height, ele.current.childNodes[high].style.height ] = [ ele.current.childNodes[high].style.height, ele.current.childNodes[i + 1].style.height ];
